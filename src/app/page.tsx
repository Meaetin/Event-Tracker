...
export default function HomePage() {
  return (
    <>
      <div className='mt-16 md:mt-20 pt-6 md:pt-10'>
        {/* Hero Section */}
        <div className="text-center mb-8 md:mb-12 px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex justify-center">
            <Link 
              href="/events"
              className="inline-flex items-center px-4 py-2 sm:px-6 sm:py-3 border border-transparent text-sm sm:text-base font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-200"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 mb-8 md:mb-12 px-4 sm:px-6 lg:px-8 xl:px-20 py-6 md:py-10">
          <div className="text-center p-4 sm:p-6 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-200">
            ...
            <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2">Interactive Map</h3>
          ...
          <div className="text-center p-4 sm:p-6 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-200 md:col-span-2 lg:col-span-1">
            ...
            <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2">AI-Powered</h3>
            <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
        ...
        <div className="px-4 sm:px-6 lg:px-8 py-8 md:py-12">
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            ...
            <div className="lg:col-span-1">
              <h3 className="text-lg sm:text-xl font-bold mb-3 md:mb-4">EventScape Singapore</h3>
            ...
            {/* Contact Section */}
            <div className="lg:col-span-1">
              <h4 className="text-base sm:text-lg font-semibold mb-3 md:mb-4">Contact Me</h4>
              <div className="space-y-3">
